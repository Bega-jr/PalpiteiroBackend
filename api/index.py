...
from app.routes.concurso import router as concurso_router  # 👈 novo
from app.routes.debug import router as debug_router # 👈 novo
...
app.include_router(concurso_router)  # 👈 novo
app.include_router(debug_router)# 👈 novo
